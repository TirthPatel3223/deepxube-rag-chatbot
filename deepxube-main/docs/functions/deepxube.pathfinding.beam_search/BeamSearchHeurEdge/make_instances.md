---
id: "func:deepxube.pathfinding.beam_search.BeamSearchHeurEdge.make_instances"
kind: "method"
name: "make_instances"
qualified_name: "deepxube.pathfinding.beam_search.BeamSearchHeurEdge.make_instances"
...
callees:
  - target: "func:deepxube.pathfinding.beam_search.BeamSearchHeurEdge._create_root_nodes"
    expr: "self._create_root_nodes"
    call_sites: [224]
  - target: "func:deepxube.pathfinding.beam_search.BeamSearchHeurEdge._construct_instances"
...
# `deepxube.pathfinding.beam_search.BeamSearchHeurEdge.make_instances`

**File:** [deepxube/pathfinding/beam_search.py:221](../../../../deepxube/pathfinding/beam_search.py#L221)
**Class:** `BeamSearchHeurEdge`
**Visibility:** public
**Kind:** method
...
- `self._create_root_nodes` → `func:deepxube.pathfinding.beam_search.BeamSearchHeurEdge._create_root_nodes` (lines: 224)
- `self._construct_instances` → `func:deepxube.pathfinding.beam_search.BeamSearchHeurEdge._construct_instances` (lines: 225)
