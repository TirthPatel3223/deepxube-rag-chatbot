---
id: "class:deepxube.domains.npuzzle.NPuzzle"
kind: "class"
name: "NPuzzle"
qualified_name: "deepxube.domains.npuzzle.NPuzzle"
...
generic_parameters: []
bases:
  - name: "ActsEnumFixed[NPState, NPAction, NPGoal]"
    resolved_id: null
  - name: "GoalStartRevWalkableActsRev[NPState, NPAction, NPGoal]"
    resolved_id: null
  - name: "HasFlatSGIn[NPState, NPAction, NPGoal]"
    resolved_id: null
  - name: "StateGoalVizable[NPState, NPAction, NPGoal]"
    resolved_id: null
  - name: "StringToAct[NPState, NPAction, NPGoal]"
    resolved_id: null
methods:
  - "func:deepxube.domains.npuzzle.NPuzzle.__init__"
  - "func:deepxube.domains.npuzzle.NPuzzle.sample_goalstate_goal_pairs"
  - "func:deepxube.domains.npuzzle.NPuzzle.next_state"
  - "func:deepxube.domains.npuzzle.NPuzzle.expand"
  - "func:deepxube.domains.npuzzle.NPuzzle.get_actions_fixed"
  - "func:deepxube.domains.npuzzle.NPuzzle.rev_action"
  - "func:deepxube.domains.npuzzle.NPuzzle.is_solved"
  - "func:deepxube.domains.npuzzle.NPuzzle.get_input_info_flat_sg"
  - "func:deepxube.domains.npuzzle.NPuzzle.to_np_flat_sg"
  - "func:deepxube.domains.npuzzle.NPuzzle.visualize_state_goal"
  - "func:deepxube.domains.npuzzle.NPuzzle.string_to_action"
  - "func:deepxube.domains.npuzzle.NPuzzle.string_to_action_help"
  - "func:deepxube.domains.npuzzle.NPuzzle._is_solvable"
  - "func:deepxube.domains.npuzzle.NPuzzle._get_num_inversions"
  - "func:deepxube.domains.npuzzle.NPuzzle.random_walk"
  - "func:deepxube.domains.npuzzle.NPuzzle._get_swap_zero_idxs"
  - "func:deepxube.domains.npuzzle.NPuzzle._move_np"
  - "func:deepxube.domains.npuzzle.NPuzzle.__repr__"
attributes:
  - name: "moves"
    annotation: "List[str]"
    default: "['U', 'D', 'L', 'R']"
...
# `deepxube.domains.npuzzle.NPuzzle`

**File:** [deepxube/domains/npuzzle.py:62](../../../deepxube/domains/npuzzle.py#L62)
**Abstract:** no
**Decorators:** `@domain_factory.register_class('npuzzle')`

## Docstring

Sliding-tile puzzle registered as ``npuzzle``; blank tile slides U/D/L/R with cost 1.0 per move. 

## Inheritance

**Direct bases:**
- `ActsEnumFixed[NPState, NPAction, NPGoal]`
- `GoalStartRevWalkableActsRev[NPState, NPAction, NPGoal]`
- `HasFlatSGIn[NPState, NPAction, NPGoal]`
- `StateGoalVizable[NPState, NPAction, NPGoal]`
- `StringToAct[NPState, NPAction, NPGoal]`

**Subclasses:** *(populated by graph post-pass — see `graph.json`.)*

## Factory registration

- Factory `deepxube.factories.domain_factory.domain_factory` under key `npuzzle`
...
| Name | Type | Source |
|------|------|--------|
| `moves` | `List[str]` | class_body |
| `moves_rev` | `List[str]` | class_body |
| `self.actions` | — | __init__ |
| `self.dim` | — | __init__ |
| `self.dtype` | — | __init__ |
| `self.goal_tiles` | — | __init__ |
| `self.num_actions` | — | __init__ |
| `self.num_tiles` | — | __init__ |
| `self.swap_zero_idxs` | — | __init__ |
